...
namespace AccelEngine
{
    ...
    public:
        ...
        static bool IntersectRectangles(const std::vector<Vector2> &verticesA, Vector2 centera, const std::vector<Vector2> &verticesB, Vector2 centerB, Contact &contacts);
        ...
        static std::pair<real, real> projectOnCircle(Vector2 center, real radius, const std::vector<Vector2> &vertices, Vector2 axis);
        static int FindClosestPointOnRectangle(Vector2 center, const std::vector<Vector2> &vertices);
        ...
        // contacts
        static void FindCircleVsRectangleContact(Vector2 center, real radius, Vector2 rectCenter, const std::vector<Vector2> &verticesA, Contact &contact);
        static void FindRectVsRectContact(const std::vector<Vector2> &verticesA, const std::vector<Vector2> &verticesB, Contact &contacts);
    };
};
